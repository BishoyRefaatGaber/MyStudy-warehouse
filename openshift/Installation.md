# UPI
##### download links 
- openshift cluster manager: [Install OpenShift 4 | Red Hat OpenShift Cluster Manager | Bare Metal](https://console.redhat.com/openshift/install/metal/user-provisioned)
- DHCP
- DNS
- HAProxy
- Apache
- nmstate: NMState is a **declarative, API-driven network management tool** for Linux systems.
##### Prerequisits
